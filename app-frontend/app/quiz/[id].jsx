    ...
    <View style={styles.bg}>
      ...
      >
        ...
        <View style={styles.infoContainer}>
          <Text style={[fonts.EngRegular16, styles.description]}>{quiz?.description}</Text>
          {quiz && <TagList tags={quiz?.tags} />}
          <View style={styles.dateAuthorContainer}>
            <Text style={[fonts.EngRegular12, styles.dateText]}>{quiz?.date}</Text>
            <TouchableOpacity style={styles.authorContainer}>
              <Text style={[fonts.EngMedium12, styles.authorText]}>By {quiz?.ownerId?.username}</Text>
            </TouchableOpacity>
          </View>
        </View>

        <View style={styles.qsContainer}>
          <Text style={[fonts.EngBold18, styles.headerQs]}>{quiz?.questions?.length} Questions</Text>
        </View>
