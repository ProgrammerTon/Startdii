...
const TabArr = [
    ...
    { route: 'Archive', label: 'Archive', icon: HiFolder, component: Source },
...
const animate1 = { 0: { scale: .5, translateY: 7 }, .92: { translateY: -34 }, 1: { scale: 1.2, translateY: -7 } };
const animate2 = { 0: { scale: 1.2, translateY: -7 }, 1: { scale: 1, translateY: 7 } };

const frame1 = { 0: { scale: 0 }, 0.3: { scale: .9 }, 0.5: { scale: .2 }, 0.8: { scale: .7 }, 1: { scale: 1 } };
