  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttonsContainer}>
        ...
        <TouchableOpacity style={styles.button} onPress={() => router.push("/Guild/I4_Member")}>
        ...
        <InviteCodeWindow visible={InviteWindowVisible} onClose={closeInviteWindow} />

        <TouchableOpacity style={styles.button} onPress={openLeaveWindow}>
          <Ionicons name="exit-outline" size={24} color="green" />
          <Text style={styles.buttonText}>LEAVE</Text>
        </TouchableOpacity>
        <LeaveGuildWindow visible={LeaveGuildWindowVisible} onClose={closeLeaveWindow} />
      </View>
